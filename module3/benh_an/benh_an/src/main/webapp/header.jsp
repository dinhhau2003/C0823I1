        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/benhAn?action=list"><i class="fas fa-list"></i> Danh sách</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/benhAn?action=create"><i class="fas fa-plus-circle"></i> Thêm
                            mới</a>
                    </li>
                </ul>
            </div>
